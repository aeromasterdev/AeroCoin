...
// Aero: total coins staked (non-spendable until maturity)
...
// Aero: check 'spent' consistency between wallet and txindex
// Aero: fix wallet spent state according to txindex
...
// Aero: disable transaction (only for coinstake)
